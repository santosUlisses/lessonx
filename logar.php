...
<button type="submit" class="btn btn-primary" name="bt_entrar" id="entrar">Entrar</button>
</div>
</form>
<div class="container"><br><br><a href="loginAdm.php"><button type="submit" class="btn btn-dark">Login ADM</button></a></div>
</body>
